...
const SingleRoute = () => {
  ...
  if (currentPackageIndex === 0) {
    coordinates = [warehouse, currentPackage];
  } else if (
    totalDelivered === packages.length /* && isAtWarehouse===false */
  ) {
    coordinates = [packages[packages.length - 1], warehouse];
  } else {
    coordinates = [packages[currentPackageIndex - 1], currentPackage];
  }
