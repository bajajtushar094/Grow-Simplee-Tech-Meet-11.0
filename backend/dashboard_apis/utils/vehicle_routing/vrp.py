...
class VRP:
    ...
    def vehicle_output_plot(self, block=True):
        ...
        sf = shp.Reader('/home/gunjan/Desktop/GrowSimplee/Grow-Simplee-Tech-Meet-11.0/backend/dashboard_apis/myshapefile/myshapefile.shp')
        ...
        plt.legend()
        plt.grid()
        plt.savefig("static/Routes4.png",dpi=300)
