        ...
        <MobileLayout subHeading='Trip Route'>
            ...
            <div className='bottom_bar rounded-t-[12px] bg-white px-4 py-6 border border-[#D2D1CC]'>
                ...
                <div className='buttons flex text-center font-semibold'>
                    <div className='checklist_button rounded-full flex-1 py-3 border-[#2F2E36] border mr-2' onClick={() => {navigate('/checklist')}}>Checklist</div>
                    <button className='start_button rounded-full flex-1 py-3 bg-[#2F2E36] text-white' onClick={startTrip}>Start Trip</button>
                </div>
            </div>
            </>
